document.addEventListener('DOMContentLoaded', () => {
    ...
    /** Get Status Info **/
    function getStatus(reportId, dueDateStr) { // reportId is no longer used for 'sent' status here
    ...
    function createCharts(data) {
        ...
        // Using CSS variables for colors in JS is complex; using hex directly from palette for now
        ...
        departmentChart = new Chart(departmentChartCanvas, { 
            ...
            data: { 
                ...
                datasets: [{ data: Object.values(deptCounts), backgroundColor: chartPieColors }] 
            }, 
            options: { 
                responsive: true, 
        ...
        frequencyChart = new Chart(frequencyChartCanvas, { 
            ...
            data: { 
                ...
                datasets: [{ label: 'عدد التقارير', data: Object.values(freqCounts), backgroundColor: goldColor }] // Changed color
            }, 
            options: { 
                responsive: true, 
                maintainAspectRatio: false, // Allows height control via CSS
    ...
    function populateTable(reportsToShow) {
        ...
        reportsToShow.forEach(report => {
            ...
            const statusInfo = getStatus(id, dateString); // Pass ID, though not used for sent status anymore
    ...
    function updateKPIs(data) {
        ...
        data.forEach(report => {
            ...
            if (statusInfo.isNear) nearCount++; // near = today + next 3 days
    ...
    function renderCurrentPage() {
        ...
        updateKPIs(filteredReportsData); // Update KPIs based on currently displayed/filtered data
    }
    
    /** Populate Department Filter **/
    function populateFilter(data) {
        const departments = [...new Set(data.map(report => report[1]))]; 
        departments.sort((a, b) => a.localeCompare(b, 'ar')); // Sort Arabic strings
    ...
    async function fetchData() {
        try {
            ...
            // No loadSentStatus() needed anymore
    ...
    function handleFilterAndSearch() {
        currentPage = 1; 
        renderCurrentPage();
        createCharts(filteredReportsData); 
    }
